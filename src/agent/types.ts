...
// ---------------------------------------------------------------------------
// Explanation types (public contract — deterministic, not LLM-generated)
// ---------------------------------------------------------------------------
...
export type ExplanationCode =
  ...
  | 'no_valid_coupon'
  | 'coupon_invalid'
  | 'coupon_not_better_than_baseline'
  | 'compare_summary';

export type ExplanationDetail =
  | { type: 'money'; key: string; label: string; value: number }
  | { type: 'text'; key: string; label: string; value: string }
  | { type: 'coupon'; key: string; label: string; couponCode: string };
